import java.util.*;
public class Twp_Stacks_in_single_array {
    private int[] arr;
 private int capacity;
 private int top1, top2;

 // Constructor
 Twp_Stacks_in_single_array(int n)
 {
     capacity = n;
     arr = new int[n];
     top1 = -1;
 ...
 public static void main(String[] args)
 {
     ...
     Twp_Stacks_in_single_array stack = new Twp_Stacks_in_single_array(list1.size() + list2.size());
